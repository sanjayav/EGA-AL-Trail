...
const COMMON_DOCUMENTS = [
  ...
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 4830,
    url: '/dpp-assets/docs/certs/doc-lca-full.pdf',
    sha256: 'da77…42cf',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'LCA',
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 5240,
    url: '/dpp-assets/docs/certs/doc-product-booklet.pdf',
    sha256: 'aa11…02bd',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'Product',
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 6712,
    url: '/dpp-assets/docs/certs/doc-tech-booklet.pdf',
    sha256: 'bc44…78de',
  ...
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 980,
    url: '/dpp-assets/docs/certs/doc-asi-perf.pdf',
    sha256: '2b71…99af',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'ASI',
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 1102,
    url: '/dpp-assets/docs/certs/doc-asi-coc.pdf',
    sha256: '4ad6…1f88',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'ASI',
  },
  ...
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 412,
    url: '/dpp-assets/docs/certs/doc-msds.pdf',
    sha256: '99e1…02ab',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'MSDS',
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 880,
    url: '/dpp-assets/docs/certs/doc-test-report.pdf',
    sha256: '5d72…e3f1',
    requiresAudience: ['customer', 'verifier', 'authority'],
    tag: 'Quality',
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 220,
    url: '/dpp-assets/docs/certs/doc-reach.pdf',
    sha256: '7caa…8d44',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'REACH',
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 198,
    url: '/dpp-assets/docs/certs/doc-rohs.pdf',
    sha256: 'ae09…74c2',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'RoHS',
  },
  {
    ...
    kind: 'pdf',
    sizeKb: 1520,
    url: '/dpp-assets/docs/certs/doc-cbam.pdf',
    sha256: 'b1e8…a009',
    requiresAudience: ['verifier', 'authority'],
    tag: 'CBAM',
  },
  // ── Filler entries so every regulation + certification on a demo
  // passport resolves to a downloadable document. URLs point to the four
  // bundled EGA PDFs; sha256 is illustrative.
  {
    id: 'doc-iso-50001',
    ...
    kind: 'pdf',
    sizeKb: 624,
    url: '/dpp-assets/docs/certs/doc-iso-50001.pdf',
    sha256: 'd1aa…5cc7',
    requiresAudience: ['customer', 'verifier', 'authority'],
    tag: 'ISO',
  },
  {
    id: 'doc-iso-17025',
    label: 'ISO/IEC 17025:2017 Lab Accreditation',
    issuer: 'EIAC',
    kind: 'pdf',
    sizeKb: 540,
    url: '/dpp-assets/docs/certs/doc-iso-17025.pdf',
    sha256: '4b2e…99f0',
    requiresAudience: ['verifier', 'authority'],
    tag: 'ISO',
  },
  {
    id: 'doc-reg-cbam',
    label: 'EU CBAM · embedded-emissions declaration evidence',
    issuer: 'EGA Compliance',
    kind: 'pdf',
    sizeKb: 1480,
    url: '/dpp-assets/docs/certs/doc-reg-cbam.pdf',
    sha256: 'b1e8…a009',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'Regulation',
  },
  {
    id: 'doc-reg-espr',
    label: 'EU ESPR · DPP conformity statement (EGA-DPP-001)',
    issuer: 'EGA Compliance',
    kind: 'pdf',
    sizeKb: 612,
    url: '/dpp-assets/docs/certs/doc-reg-espr.pdf',
    sha256: 'a91c…2def',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'Regulation',
  },
  {
    id: 'doc-reg-reach',
    label: 'REACH · Article 33(1) declaration',
    issuer: 'EGA Compliance',
    kind: 'pdf',
    sizeKb: 220,
    url: '/dpp-assets/docs/certs/doc-reg-reach.pdf',
    sha256: '7caa…8d44',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'Regulation',
  },
  {
    id: 'doc-reg-rohs',
    label: 'RoHS 2 · Directive 2011/65/EU declaration',
    issuer: 'EGA Compliance',
    kind: 'pdf',
    sizeKb: 198,
    url: '/dpp-assets/docs/certs/doc-reg-rohs.pdf',
    sha256: 'ae09…74c2',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'Regulation',
  },
  {
    id: 'doc-reg-pfas',
    label: 'PFAS · REACH Annex XVII statement',
    issuer: 'EGA Compliance',
    kind: 'pdf',
    sizeKb: 240,
    url: '/dpp-assets/docs/certs/doc-reg-pfas.pdf',
    sha256: 'fa44…12cd',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'Regulation',
  },
  {
    id: 'doc-reg-alu-da',
    label: 'EU Aluminium Delegated Act · readiness assessment',
    issuer: 'EGA Compliance',
    kind: 'pdf',
    sizeKb: 410,
    url: '/dpp-assets/docs/certs/doc-reg-alu-da.pdf',
    sha256: '2a31…77be',
    requiresAudience: ['customer', 'verifier', 'authority'],
    tag: 'Regulation',
  },
  {
    id: 'doc-reg-3tg',
    label: 'Conflict Minerals · 3TG due-diligence statement',
    issuer: 'EGA Compliance',
    kind: 'pdf',
    sizeKb: 188,
    url: '/dpp-assets/docs/certs/doc-reg-3tg.pdf',
    sha256: '9d10…44ee',
    requiresAudience: ['public', 'customer', 'verifier', 'authority'],
    tag: 'Regulation',
  },
