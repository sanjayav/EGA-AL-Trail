...
export default function NotFound() {
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center px-6">
      ...
      <h1 className="mt-4 font-display text-[clamp(48px,8vw,96px)] font-light leading-[0.95] text-[var(--fg-default)]">
        Nothing here.
      </h1>
      <p className="mt-4 max-w-md text-[16px] text-[var(--fg-muted)]">
        The Digital Product Passport you're looking for doesn't exist, has been
        withdrawn, or has expired beyond the 10-year retention window.
      </p>
      <Link
        href="/"
